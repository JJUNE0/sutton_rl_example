...
def figure_8_2():
    ...
    plt.savefig('sutton_rl/chapter08/figure_8_2.png')
    plt.close()
...
def figure_8_4():
    ...
    plt.savefig('sutton_rl/chapter08/figure_8_4.png')
    plt.close()
...
def figure_8_5():
    ...
    plt.savefig('sutton_rl/chapter08/figure_8_5.png')
    plt.close()
...
def example_8_4():
    ...
    plt.savefig('sutton_rl/chapter08/example_8_4.png')
    plt.close()
